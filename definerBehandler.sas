...
If BoSHHN=1 then do;
	...
	else if BehSh in (20,22,23,30,31,32,40,41,42,43) then Behandler=5;
...
*	else if BehSh=21 then Behandler=2;
	...
	else if BehSh in (10,11,12,30,31,32,40,41,42,43) then Behandler=5;
	else if BehRHF in (2,3,4) then Behandler=6;
	else if BehRHF=5 then Behandler=7;
	else if BehRHF=6 then Behandler=8;
end;
...
If BoSHHN=9 then do;
	...
	else if BehSh in (10,11,12,20,22,23,30,31,32) then Behandler=5;
	else if BehRHF in (2,3,4) then Behandler=6;
	else if BehRHF=5 then Behandler=7;
	else if BehRHF=6 then Behandler=8;
end;
...
If BoSHHN=12 then do;
	...
	else if BehSh in (10,11,12,20,22,23,30,31,32,40,41,42,43) then Behandler=5;
	else if BehRHF in (2,3,4) then Behandler=6;
	else if BehRHF=5 then Behandler=7;
	else if BehRHF=6 then Behandler=8;
end;
